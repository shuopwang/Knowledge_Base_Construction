 ...
 * 
 * In the simple Database, it will create a database that with links, labels,reverseLabels
 * Links(same-key, mutli-value)
 * labels(same-key, mutli-value)
 * reverse Labels(lable's value, mutli-key)
